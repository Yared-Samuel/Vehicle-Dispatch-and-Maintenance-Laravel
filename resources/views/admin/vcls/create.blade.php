...
<x-admin-layout>
    ...
    <div class=" border-b-gray-200  mb-10 pb-10 h-screen">
        <div class="flex justify-end bg-slate-200">
            ...
            <div class="max-w-6xl  mx-auto sm:px-6 lg:px-8 bg-slate-100 rounded-md pt-4">
                ...
                <div class="flex justify-around">
                    <div>
                    <div class="relative z-0 mb-6 w-full group bg-white border-2">
                    ...
                    <div class="relative z-0 mb-6 w-full group bg-white border-2">
                        ...
                        <label for="plate_code" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-85 top-2 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                        >Plate Code *</label>
                    </div>
                    <div class="relative z-0 mb-6 w-full group bg-white border-2">
                ...
                <div>
                    ...
                    <div class="relative z-0 mb-6 w-full group bg-white border-2">
                        ...
                        <label for="munifucture date" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-85 top-0 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
