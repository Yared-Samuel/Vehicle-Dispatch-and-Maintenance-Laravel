    ...
    <div class=" border-b-gray-200  mb-10 pb-10 h-screen">
        <div class="flex justify-end">
            ...
            <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
                ...
                <form method="POST" action="{{ route('admin.vcls.index') }}">
                    @csrf
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        <input type="text" name="vcl_model" id="vcl_model" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        ...
                        <select name="fuel_type" id="fuel_type" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" >
                    ...
                    <div class="relative z-0 mb-6 w-full group">
                        ...
                        <select name="category_id" id="category_id" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" >
                            ...
                            @foreach ($vcl_blgto_cats as $vcl_blgto_cat)
                            <option value="{{ $vcl_blgto_cat->id }}">{{ $vcl_blgto_cat->category_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="relative z-0 mb-6 w-full group">
