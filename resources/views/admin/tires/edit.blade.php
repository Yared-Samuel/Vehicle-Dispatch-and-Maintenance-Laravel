    ...
    <div class="">
        ...
        <div class="flex justify-between w-full px-4 py-2 items-center">
            ...
            <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <form method="POST" action="{{ route('admin.tires.update',$tirechart->id )}}">
                            @csrf
                            @method('PUT')

                        <div class="flex justify-around">
                             <div class="relative z-0 mb-10 w-1/3 group">
                                <input type="number" name="serial_num" value="{{ $tirechart->serial_num }}" id="serial_num" class="dynamic block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-4 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer" placeholder=" " disabled />
