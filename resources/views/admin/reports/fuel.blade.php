<x-admin-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between sticky top-0 bg-slate-300 w-full px-4 py-2 items-center rounded-sm">
            ...
            <div >
            <select name="vcl"  id="underline_select" class="mx-10 px-4 w-3/2 text-sm font-semibold text-black bg-white border-1 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer rounded-md">
